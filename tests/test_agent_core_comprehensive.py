...
def agent_with_htn(mock_config):
    ...
    with (
        patch("runtime.agent.get_config", return_value=mock_config),
...
class TestAgentChat:
    ...
    def test_chat_routes_to_htn(self, agent_with_htn):
        ...
        with (
            patch.object(agent_with_htn, "_requires_planning", return_value=True),
    ...
    def test_chat_routes_to_simple(self, agent_with_htn):
        ...
        with (
            patch.object(agent_with_htn, "_requires_planning", return_value=False),
