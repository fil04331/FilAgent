...
from eval.planning_validator import Task, PlanValidator, evaluate_planning_capability
...
class TestEvaluationTarget:
    ...
    def test_invalid_operator_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Invalid operator"):
            EvaluationTarget(benchmark="test", metric="score", operator=">>", value=50)  # Invalid
...
class TestEvaluationTargetLoader:
    ...
    def test_load_targets_from_benchmarks_format(self):
        ...
        config = {
            "benchmarks": {
                "humaneval": {"enabled": True, "pass_at_1": 0.65, "pass_at_10": 0.85},
                "mbpp": {"enabled": True, "pass_at_1": 0.60},
            }
        }
...
class TestTargetValidator:
    ...
    def test_validate_all_passing(self):
        ...
        results = {"humaneval": {"pass_rate": 0.70}, "mbpp": {"pass_rate": 0.65}}
    ...
    def test_validate_some_failing(self):
        ...
        results = {"humaneval": {"pass_rate": 0.70}, "mbpp": {"pass_rate": 0.55}}  # Below target
    ...
    def test_validate_missing_metric(self):
        ...
        targets = [EvaluationTarget("humaneval", "pass_rate", ">=", 0.65)]

        results = {"humaneval": {"other_metric": 0.70}}  # Missing pass_rate
...
class TestPlanValidator:
    ...
    def test_simulate_execution_deadlock(self):
        ...
        tasks = [Task("task1", "First", {"task2"}), Task("task2", "Second", {"task1"})]
...
class TestIntegration:
    ...
    def test_end_to_end_validation(self):
        ...
        # Create targets
        targets = [EvaluationTarget("test_bench", "score", ">=", 75.0)]

        # Create results
        results = {"test_bench": {"score": 80.0}}
