...
class TestComplianceIntegration:
    ...
    def test_compliance_rejection_flow(self):
        ...
        plan = {
            'actions': [
                {'tool': 'dangerous_operation', 'params': {}}
            ]
        }
    ...
    def test_compliance_decision_record_completeness(self):
        ...
        required_fields = [
            'dr_id', 'timestamp', 'decision_type', 'actor', 'task_id',
            'query_hash', 'plan_hash', 'execution_hash', 'tools_used',
            'success', 'compliance_frameworks', 'metadata'
        ]
