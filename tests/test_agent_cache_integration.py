...
class TestAgentCacheIntegration:
    ...
    def test_agent_cache_hit(
        self, mock_cache_dependencies, mock_agent_config, mock_model, tmp_path
    ):
    ...
    def test_agent_cache_miss_fallback(
        self, mock_cache_dependencies, mock_agent_config, mock_model, tmp_path
    ):
    ...
    def test_agent_cache_error_fallback(
        self, mock_cache_dependencies, mock_agent_config, mock_model
    ):
