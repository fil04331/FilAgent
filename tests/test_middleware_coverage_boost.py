...
class TestLoggingMiddleware:
    ...
    def test_log_event(self):
        ...
        logger = EventLogger()
        logger.log_event(actor="test", event="test_event", level="INFO", metadata={"key": "value"})
    ...
    def test_event_log_levels(self):
        ...
        for level in ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]:
            logger.log_event(actor="test", event="test_event", level=level)
...
class TestProvenanceMiddleware:
    ...
    def test_track_generation(self):
        ...
        trace_id = tracker.track_generation(
            conversation_id="test-conv-123", input_message="Test message"
        )
...
class TestModelInterface:
    ...
    def test_generation_config_creation(self):
        ...
        config = GenerationConfig(temperature=0.7, max_tokens=1000, top_p=0.9, top_k=40)
...
class TestAgentInternals:
    ...
    def test_agent_tool_call_parsing(self):
        ...
        with (
            patch("runtime.agent.get_config", return_value=config),
