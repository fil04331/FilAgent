...
class TestTemplateSystemIntegration:
    ...
    def test_planner_with_template_loader(self):
        ...
        planner = HierarchicalPlanner(model_interface=mock_model, template_loader=loader)
...
Les PME québécoises bénéficient de plusieurs programmes de subventions..."""
        ...
        prompt = builder.build_system_prompt(mock_registry, semantic_context=semantic_context)
