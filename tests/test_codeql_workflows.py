...
class TestCodeQLWorkflows:
    ...
    def test_codeql_workflow_has_required_triggers(self, codeql_workflow):
        ...
        # YAML peut parser 'on:' comme True (boolean), on doit chercher la clé True ou 'on'
        triggers = None
    ...
    def test_codeql_workflows_use_consistent_python_version(
        ...
        assert version2 is not None, "Le workflow codeql-security.yml doit définir une version Python"
    ...
    def test_codeql_security_workflow_has_custom_checks(
        self, codeql_security_workflow
    ):
