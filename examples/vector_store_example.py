...
- Conseils en marketing local
    ...
    try:
        ...
        chunks = ingest_document(
            temp_path, use_sentence_chunking=True, metadata={"document_type": "product_description"}
        )
...
def example_3_context_injection():
    ...
    semantic_context = context_builder.inject_semantic_context(
        query=user_query, top_k=2, semantic_memory=store
    )
