...
from eval.target_validator import EvaluationTargetLoader, TargetValidator, validate_from_config
...
def example_benchmark_results():
    ...
    """
    return {
        "humaneval": {"pass_at_1": 0.67, "pass_at_10": 0.88, "avg_latency_ms": 450},
        "mbpp": {"pass_at_1": 0.62, "pass_at_10": 0.83, "avg_latency_ms": 380},
        "compliance": {
...
def example_simple_usage():
    ...
    results = validate_from_config(
        benchmark_results=example_benchmark_results(), config_path="config/eval_targets.yaml"
    )
