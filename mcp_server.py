...
class FilAgentMCPServer:
    ...
    async def initialize(self) -> MCPResponse:
        ...
        try:
            ...
            return {"error": {"code": -32603, "message": f"Erreur initialisation: {str(e)}"}}
    ...
    async def handle_request(self, message: MCPRequest) -> MCPResponse:
        ...
        try:
            ...
            if method == "initialize":
                ...
                return {"error": {"code": -32601, "message": f"Méthode non supportée: {method}"}}
